...
SECRET_KEY = 'django-insecure-%i#pltj^@68p4s8kzk#&+%x17#@$4mea*o+=gx1h_9q4f28d2p'
...
EMAIL_FROM_ADDRESS = 'eescappe@gmail.com'  # mandatory
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'eescappe@gmail.com'
EMAIL_HOST_PASSWORD = env('EMAIL_HOST_PASSWORD')# 'hudy tfsb brby voql'
